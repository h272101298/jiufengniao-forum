...
@section('content')
    ...
    <div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','{{route('role/add')}}','800')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            @foreach($data as $val)
                <tr class="text-c">
                    ...
                    <td>{{$val->auth_ac}}</td>
                    <td class="f-14">
                        <a title="分配权限" href="javascript:;" onclick="admin_role_assign('分类权限','{{route('role/add',['id'=>$val->id])}}','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe60c;</i></a>
