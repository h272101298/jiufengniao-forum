    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            ...
            <dl id="menu-admin">
                ...
                <dd>
                    <ul>
                        <li><a data-href="{{route('role/index')}}" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
                        <li><a data-href="{{route('auth/index')}}" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
                        <li><a data-href="{{route('manager/index')}}" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-tongji">
