                ...
                @foreach($data as $val)
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            ...
                            @else
                            <a style="text-decoration:none" onClick="admin_start(this,'10001')" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe615;</i>
                            </a>
                            @endif
...
@stop
@section('js')
    <script type="text/javascript" src="{{asset('assets/admin/lib/My97DatePicker/4.8/WdatePicker.js')}}"></script>
